...
$(function () {
    // Save DOM references.
    var iframe = $('iframe#insights');
    var iframeSrc = iframe.attr('src');
    var indexInput = $('input');
    var imagesLocation = $('#imagesLocation');
    var iframeUrlInput = $('#iframeUrl');
    // Update the iframe embed url from the form inputs.
    $('#loadBtn').click(function () {
        var url = iframeSrc + "?customIndexLocation=" + encodeURIComponent(indexInput.val()) + "&customImagesLocation=" + encodeURIComponent(imagesLocation.val());
        iframe.attr('src', url);
